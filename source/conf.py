...
project = 'Overte build system documentation'
copyright = 'Copyright 2023 Overte e.V.'
author = 'Julian Groß'
...
gettext_compact = "overte-build-system-docs"
...
html_title = "Overte Build System Documentation"
